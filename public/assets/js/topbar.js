...
(function () {
  ...
  header.dir = 'rtl';
  header.innerHTML = `
    <div class="brand" aria-label="Waslny"><span>Wasl</span><b>ny</b></div>
  ...
  document.getElementById('mi-about').onclick = ()=> alert('عن التطبيق: Waslny v1.0.0');
